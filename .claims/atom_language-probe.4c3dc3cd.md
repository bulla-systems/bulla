...
{
  "v": 2,
  "cid": "bafyreiffqm7fz3gnvsvezbhpmdqdf5y3dvmzqqy2zpvgd7kbk3kpidqksy",
  "sig": "7e85d5a01ee5817246e7f7a61ba95b23fb60f259f290916f8a5e92ba4526f431006689c1d2532e028fbd91eb7d10661ba208f3433e0f353768810efa6114745c",
  "author": "did:key:zDnaetDEzdwnPyn7iTx9FyFPxJDK6f9npD9HNjUfVsgHBky6w",
  "subject": "Local(\"atom/language-probe\")",
  "kind": "Observation",
  "cites": [],
  ...
  "of": 35,
  "text_len": 1288,
  "content": ""
}
---

Stage 0 protocol probe, five findings. (1) Protocol fidelity is enforceable today with no new syntax: a session as a state machine with a precondition naming the legal message per step certifies at L3 for every item, and a caller that replies at step 0 fails with 'precondition not satisfied'. So the protocol RFC proposes sugar over something provable rather than a new obligation. (2) The contract is non-vacuous and kills 5 of 6 mutants. (3) Affine permits abandoning a session mid-protocol: abandon(s: Session) -> u64 verifies, since nothing in a contract can say 'you must call advance again', which is liveness. That is the concrete evidence for endpoints having to be resources - the safety half is reachable today and the completion half is not. (4) G12's scope is wider than recorded: the equivalence probe supports only scalar PARAMS as well as scalar returns, so abandon returning a scalar u64 is still rejected WeakContract at 1/2 because its param is a declared struct. The affected class is every function mentioning a declared type in its signature, not just those returning one. (5) ens true is rejected outright as EnsIsTrivial section 7.1(a) at L0 while req true certifies at L3, so 'ensures nothing' cannot be a spelling a program keeps - it is one the checker refuses.
---8<---
---
{
  "v": 2,
  "cid": "bafyreiham7lhnxij5mjkeayyvbwymdzifww45e5db2yc3dyd4szqkdgswm",
  "sig": "b3283d36ff7f17213d410fe9cf629421136da027fdd62c1d823f929f70f99b8578121f20546c7aeb0ca5076acea448488f598b33900fdd0caae115a6bf96cdfe",
  "author": "did:key:zDnaetDEzdwnPyn7iTx9FyFPxJDK6f9npD9HNjUfVsgHBky6w",
  "subject": "Local(\"atom/language-probe\")",
  "kind": "Publication",
  "cites": [],
  ...
  "seq": 24,
  "of": 35,
  "content": ""
}
---
---8<---
---
{
  "v": 2,
  "cid": "bafyreihgxcimt6adj6wrq3voyq766miuaigzx4bjyaaff5upnhjv7snlw4",
  "sig": "519016a2028ecd22d5cabb221c446e81b728f5c9acb7c5303bc2a90c32e2f4c31cae302a1f544d07deb52dac6df550360b8a7f6c11440e7cd6416dd6415a3292",
  "author": "did:key:zDnaetDEzdwnPyn7iTx9FyFPxJDK6f9npD9HNjUfVsgHBky6w",
  "subject": "Local(\"atom/language-probe\")",
  "kind": "Observation",
  "cites": [],
  ...
  "of": 35,
  "text_len": 1608,
  "content": ""
}
---

The interference lowering hypothesis is discharged. asks/promises factor onto the tokenized-state-machine machinery through PERSISTENT SHARDING: vstd ships persistent_option, persistent_map, persistent_set, persistent_bool and persistent_count, and tokens.rs states the property that makes them the right target - for persistent_set the token for any given element is not unique but is Copy. A persistent token is duplicable precisely because the fact it witnesses can never be retracted, so an observation of monotone shared state survives any concurrent transition. That is the rely, as a type. persistent_count makes it explicit with weaken(count) requires count <= self.count(), which is 'whatever you observed is a lower bound that stays a lower bound' as a lemma that already ships. The confirmed scope equals the declared scope: the document covers shared-lock-free-monotone and puts arbitrary out of reach, and the persistent shardings cover the monotone fragment and nothing more, so a boundary drawn on taste is the boundary the substrate draws. ONE GAP FOUND: the worked example's rely has two conjuncts and only one maps. Monotone growth is persistent sharding; stability (final(s).epoch == s.epoch) is not, because a persistent token witnessing epoch == e would have to be invalidated when the epoch advances, which is what persistence forbids. sharding(constant) covers a field that never changes at all and the epoch is not that either - it is constant for the duration of one shootdown and changes between them. So a stability conjunct is a protocol-scoped fact rather than a field-level one.
---8<---
---
{
  "v": 2,
  "cid": "bafyreiebhvyrh336osnnigc3bqjgkjhyhz4m74tth23ollchvqainq63gq",
  "sig": "667fd75d51a4b5494a080d0c9348a76b7c099e45ee3d8b0f3eab8ba491bb49b32b3a61d9df0bf70d0ec877f26b6854be10778e43efe56270feba4585079de76f",
  "author": "did:key:zDnaetDEzdwnPyn7iTx9FyFPxJDK6f9npD9HNjUfVsgHBky6w",
  "subject": "Local(\"atom/language-probe\")",
  "kind": "Publication",
  "cites": [],
  ...
  "seq": 26,
  "of": 35,
  "content": ""
}
---
---8<---
---
{
  "v": 2,
  "cid": "bafyreid33hj2o7z7tcsyzgltjkcsz47p2dgcx5gqwlmcqdinxgzydur7ai",
  "sig": "2e66e6e3846c70080890e08d96a91af880ca2034c05fba36f5af3371d9a04a4324ab0623416aae28450019270f708a6f4216068bef39411782c016b00aaf3a98",
  "author": "did:key:zDnaetDEzdwnPyn7iTx9FyFPxJDK6f9npD9HNjUfVsgHBky6w",
  "subject": "Local(\"atom/language-probe\")",
  "kind": "Observation",
  "cites": [],
  ...
  "of": 35,
  "text_len": 1641,
  "content": ""
}
---

Filing prep for the spec-surface defects turned up better claims rather than softer ones. ITEM 1 WAS WRONG: the bool-to-nat rewrite is not about recursion and not about the measure. is_adt_fold_sum (lower.rs:4078) classifies a body as a numeric fold when its tail is a Match and ANY ARM CONTAINS A CALL WITH A DEREF ARGUMENT, via expr_has_deref_call_arg (:4096); such a body joins the program-wide nat_fns set (:891) and is lowered with a nat return, and the declared return type is consulted nowhere in that path. Proved by a NON-RECURSIVE reproduction: spec fn calls_it(t: Tree) -> bool whose only ADT arm calls depth(*l) is emitted as -> nat. The classifier was built for numeric folds and its own comment says the base arms are coerced to nat uniformly by the nat return, which is right for sum_list and wrong for any ADT match calling through a Box deref. Fix: gate the classification on the declared return type at the filter_map building nat_fns. ITEM 3 IS SUBSTANTIATED, not softened: combinator definitions are emitted from a collection walk whose driver (lower.rs:1783) has arms for a function's req and ens, its body's loop clauses, and a spec fn's dec and body, and NO ARM for a struct or enum inv - so a combinator named there is never collected and never emitted. ITEM 2 IS SUBSTANTIATED: the Vec wrapper does emit spec_get (lower.rs:5100). AND THE FILING PLAN CHANGES: item 3 is not the same defect as #122 and should not be a comment on it. #122 is item_subprogram's ADT arm not weaving a declaration, in forge/src/check.rs; item 3 is the combinator walk in thermite-lower having no ADT arm. Different paths, different fixes.
---8<---
---
{
  "v": 2,
  "cid": "bafyreifpglha4lhvny3fbkmyksogkbwgbbtsih3c4v5bmls7lzh27ubtei",
  "sig": "ebca3e28dc04e07b562afb3c52bad05193f6b6a443b38145d7dcbb6f278ad1990b792ee49037e6723c97bcc334892a89deee83c303eb49d13c7cf62ff5ae77ec",
  "author": "did:key:zDnaetDEzdwnPyn7iTx9FyFPxJDK6f9npD9HNjUfVsgHBky6w",
  "subject": "Local(\"atom/language-probe\")",
  "kind": "Publication",
  "cites": [],
  ...
  "seq": 28,
  "of": 35,
  "content": ""
}
---
---8<---
---
{
  "v": 2,
  "cid": "bafyreiglcujzjqfhtrpkke36koymh7fr3wzmhjsu7dkguqjcb3mxrr4are",
  "sig": "6a7b61a91ed07d9d5e880b8b221943a30317b146bbbdba2a347139f3aa0e787d423794ecf79e423f56c2a530c9daea588bf8d7c6f006134e7d2414919bbac457",
  "author": "did:key:zDnaetDEzdwnPyn7iTx9FyFPxJDK6f9npD9HNjUfVsgHBky6w",
  "subject": "Local(\"atom/language-probe\")",
  "kind": "Observation",
  "cites": [],
  ...
  "of": 35,
  "text_len": 594,
  "content": ""
}
---

The Thermite 2 clause order is req, ens+, fx, then an OPTIONAL dec - the effect row is not last. A recursive fn carries its measure after the row, confirmed by examples/editor/editor.th which reads 'ens ... fx pure ... dec end - i', and by an earlier probe of mine that wrote req/ens/fx/dec and certified L3 without my noticing. Both the surface-conventions and the anchor documents said 'fx x1 last', which is wrong. Found by a round-trip migration check rather than by reading: rewriting v2 to v3 and back produced ens/ens/dec/fx where the original was ens/ens/fx/dec, for one file out of 67.
---8<---
---
{
  "v": 2,
  "cid": "bafyreig7ikkyb2zonludwop6qvp34abotwoimdlupmqxkecxx42dtuiq5y",
  "sig": "792566650a00191eb56e23b00c61b02c704e7257948192f1c3d89c9373b1142c01bda6b3999e81517e04c0fcd6367462de1388b6dd8058086ee9a0fac3eec7d3",
  "author": "did:key:zDnaetDEzdwnPyn7iTx9FyFPxJDK6f9npD9HNjUfVsgHBky6w",
  "subject": "Local(\"atom/language-probe\")",
  "kind": "Publication",
  "cites": [],
  ...
  "seq": 30,
  "of": 35,
  "content": ""
}
---
---8<---
---
{
  "v": 2,
  "cid": "bafyreib457aaxgtkpynupqlzdajq7pqut477vl7wdwopz3ggfdn4mvyjsy",
  "sig": "30652c3fc1a518ec4d8f3f4d22ac9ad34c04cbd1def7662a22325883ff03ac5d53b7ef745f0f8570485da51b47892ecae9efb4d419b05cdf2a5343c8d185a425",
  "author": "did:key:zDnaetDEzdwnPyn7iTx9FyFPxJDK6f9npD9HNjUfVsgHBky6w",
  "subject": "Local(\"atom/language-probe\")",
  "kind": "Observation",
  "cites": [],
  ...
  "of": 35,
  "text_len": 950,
  "content": ""
}
---

Two open questions in the anchor implementation plan settled by probe. The effect row marker is unambiguous by position: migrating the whole corpus and scanning every line gives 144 row lines and zero other lines beginning with '!', so a Bang at line head can only be the row. The three clause expressions that open with a negation are unaffected because the ! follows a keyword. And forge/src/relax.rs does not generate .th source as suspected - its hits are doc-comment semantics and diagnostics naming semantic addresses like ens#{k}, so it needs a rename rather than a rewrite. The first count of the embedded corpus also lumped three treatments together and overstated the mechanical work: 762 clause lines of .th source in string literals across 114 files need the tool, 114 address strings across 27 files need a rename, and 2149 doc-comment mentions need nothing, since prose describing 'req -> ens' is dated after a rename rather than wrong.
---8<---
---
{
  "v": 2,
  "cid": "bafyreihxqrsaequ7jrkncq2ncjfoazpexn5vl2y64hn5asw6utdyx3gs2q",
  "sig": "4c408e7aa74d055aade5d632a978f25bee4dc88aaca32083ac9523a8146470b45b0d0a34edc48f2b7a4bc1465dde05024a3b5da099fd3e7771b5ea23f5d11e5c",
  "author": "did:key:zDnaetDEzdwnPyn7iTx9FyFPxJDK6f9npD9HNjUfVsgHBky6w",
  "subject": "Local(\"atom/language-probe\")",
  "kind": "Publication",
  "cites": [],
  ...
  "seq": 32,
  "of": 35,
  "content": ""
}
---
---8<---
---
{
  "v": 2,
  "cid": "bafyreihlzrpccwr6ohyhes3wusoy7aj2b2thrv5jb66rmxavltl66nyvkm",
  "sig": "c227aedbbe3aa92ce2e76c4c465edb4fe219d92c8c4641ee5ddf7e4418559f0e5a3db2a9f0fa3b29101f4043bbbe467629b9a1592b26af22f94fee17d885a616",
  "author": "did:key:zDnaetDEzdwnPyn7iTx9FyFPxJDK6f9npD9HNjUfVsgHBky6w",
  "subject": "Local(\"atom/language-probe\")",
  "kind": "Result",
  "cites": [],
  ...
  "of": 35,
  "text_len": 1046,
  "content": ""
}
---

The anchor's front-end change was spiked against the real tree and works. Four keyword renames in the lexer, fx removed as a keyword entirely since the row is ! and Bang already lexed, the row moved to the head of parse_contract, and clause names in diagnostics renamed: 63 insertions and 62 deletions across five files in thermite-syntax. The migrated corpus then certifies IDENTICALLY - parse_u64 1 at L3, list_sum 2, option_result 5, multi_adt 5, map_kv 1, bytes_eq_demo 4, eighteen items at the same levels as baseline. That is the check the round-trip explicitly cannot make: the rename preserves meaning to the prover, not only information in the text. Two forms the tool did not handle were found by the test suite rather than by the round-trip, which is silent about what it fails to touch: a struct invariant trailing its closing brace (12 sites, now handled), and a whole contract on one line (373 sites across 83 files, NOT handled - an attempt dropped the round-trip from 384/384 to 329/384 and was backed out rather than left wrong).
---8<---
---
{
  "v": 2,
  "cid": "bafyreig26qfy53ydhodp74qsttc4tsv67zk3jvnkqemirqv4gbigugpzju",
  "sig": "cbb5eeaef1badcdc3234b67eac1d5027ecb0ceabd7a15059c3d5c9a8a70c01605b2614553ca83a773545e668a421392d97ad7fd51ab5fb4893c32cf5933ec5c5",
  "author": "did:key:zDnaetDEzdwnPyn7iTx9FyFPxJDK6f9npD9HNjUfVsgHBky6w",
  "subject": "Local(\"atom/language-probe\")",
  "kind": "Publication",
  "cites": [],
  ...
  "seq": 34,
  "of": 35,
  "content": ""
}
---
