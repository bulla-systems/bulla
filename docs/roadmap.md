...
|---|---|---|---|---|
| T0 | privilege / context | privilege non-escalation and generation safety, plus no kernel address, canonical addresses and stack alignment at creation | [G4](language-gaps.md#g4-struct-fields-of-user-declared-types) / upstream [#122](https://github.com/dollspace-gay/Thermite/issues/122) | NOT STARTED |
